...
def parse_all_args():
    ...
    parser.add_argument('--lrCNN', type=float, default=1e-3, help='')
    parser.add_argument('--lrRele', type=float, default=1e-3, help='')
    ...
    parser.add_argument('--batchPerModelSave', type=int, default=1, help='')
